<template>
  <div @click.prevent="handleClick" :style="styleProps" class="f-shape-component" :draggable="false">
  </div>
</template>
<script lang="ts">
...
const defaultProps = transformToComponentProps(componentsDefaultProps['f-shape'].props, isEditingProp)
